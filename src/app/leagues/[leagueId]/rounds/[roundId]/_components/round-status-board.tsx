...
export function RoundStatusBoard({
  ...
  // Only show status board during active phases where tracking matters
  if (status === "RESULTS" || status === "COMPLETED") {
    // In results, we rely on the detailed results view
    return null;
  }
  ...
  // Sort: Those who haven't acted first, then those who have
